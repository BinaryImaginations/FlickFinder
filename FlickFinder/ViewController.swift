...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    let API_KEY = "5fed00eeb87dd45439bb011659839c07"
    // Secret c320b2d2648a38ac
    let GALLERY_ID = "5704-72157622566655097"
    let SEARCH_STRING = "baby asian elephant"
    let SAFE_SEARCH = "1"
    let EXTRAS = "url_m"
    ...
    @IBAction func searchByElephant(sender: AnyObject) {
        /* Added from student request -- hides keyboard after searching */
        self.dismissAnyVisibleKeyboards()
    ...
    func validLatitude() -> Bool {
        if let latitude = NSNumberFormatter().numberFromString(latitudeTextField.text) as? Double {
    ...
    func validLongitude() -> Bool {
        if let longitude = NSNumberFormatter().numberFromString(longitudeTextField.text) as? Double {
